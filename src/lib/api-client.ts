...
class ApiClient {
  ...
  products = {
    ...
    getAnalytics: () =>
      this.get<AnalyticsData>('/products/analytics'),
  };

  // Product Variants API
  variants = {
    getAll: (params?: { page?: number; limit?: number; productId?: string }) =>
      this.get<ProductVariant[]>(buildUrl('/variants', params)),
  ...
  imports = {
    getAll: (params?: { page?: number; limit?: number; status?: string }) =>
      this.get<ImportPhase[]>(buildUrl('/imports', params)),
  ...
  transactions = {
    getAll: (params?: { page?: number; limit?: number; type?: string; productId?: string }) =>
      this.get<Transaction[]>(buildUrl('/transactions', params)),
  ...
  revenue = {
    getAll: (params?: { page?: number; limit?: number; salesChannel?: string }) =>
      this.get<RevenueEntry[]>(buildUrl('/revenue', params)),
  ...
  channels = {
    getAll: (params?: { page?: number; limit?: number; type?: string; isActive?: boolean }) =>
      this.get<SalesChannel[]>(buildUrl('/channels/sales-channels', params)),
    ...
    getAnalytics: (id?: string) =>
      this.get<AnalyticsData>(`/channels/sales-channels${id ? `/${id}` : ''}/analytics`),
  };

  // Channel Fee Structures API
  fees = {
    getAll: (params?: { page?: number; limit?: number; salesChannelId?: string; isActive?: boolean }) =>
      this.get<ChannelFeeStructure[]>(buildUrl('/channels/fee-structures', params)),
    ...
    getAnalytics: (id?: string) =>
      this.get<AnalyticsData>(`/channels/fee-structures${id ? `/${id}` : ''}/analytics`),
